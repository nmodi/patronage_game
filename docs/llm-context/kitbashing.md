...
**For what's still open** — the artist commission for the organic pieces ([artist-brief.md](../artifacts/artist-brief.md)); the panel-to-fitting migration completed July 2026 — see [procedural-pieces.md](procedural-pieces.md). This section is the field notes; that one is the plan.
