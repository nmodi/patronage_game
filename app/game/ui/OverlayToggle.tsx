...
import { AUTHORED_RGB, ORGANIC_RGB } from "~/game/render/gatheringOverlay";
    ...
    <div className="flex flex-col items-end gap-2">
      ...
      {open && (
        <Panel className="w-52 px-3 py-2 text-xs text-ink">
          ...
          <LegendRow color="rgba(226,150,60,0.75)" label="Where crowds would linger" />
          ...
          <div className="mt-1 text-ink-faint">
            Open ground at full warmth, framed by the city, becomes a piazza.
          </div>
        </Panel>
      )}
    </div>
