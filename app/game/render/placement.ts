...
export function createPlacementController(scene: Scene) {
  ...
  // buildings block — and water blocks everything but bridges (mirrors the
  // store's placeTiles gate). Returns the cells that still need placing (and
  // paying for), or null if the stretch is blocked or unaffordable.
